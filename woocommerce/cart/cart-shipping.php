...
<tr class="woocommerce-shipping-totals shipping">
	<th><div class='u-flex u-align-v-center'><?php echo wp_kses_post( $package_name ); ?>&nbsp;
				...
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						if ($method->method_id == 'free_shipping') {
							if (get_field('tooltip_delivery', 'option')) : ?>
							&nbsp;<div class="b-tooltip fade" data-title="<?php the_field('tooltip_delivery', 'option') ;?>">?</div>
						<?php endif;
						}
