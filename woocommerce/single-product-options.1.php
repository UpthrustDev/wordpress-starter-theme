...
function product_options() {
	...
	<script>
		...
		function colorsInit() {
			const flavorPickers = document.querySelectorAll('.flavor-selector');

			flavorPickers.forEach(function(item, i) {
			...
			activePicker = document.querySelector('.flavor-selector[data-val="' + currentFlavor + '"]');
		...
		function switchActivePicker(e) {
			...
			const selectVal = e.currentTarget.dataset.val;
			const currentPicker = document.querySelector('.flavor-selector.active');
			currentPicker.classList.remove('active');
			
			activePicker = document.querySelector('.flavor-selector[data-val="' + selectVal + '"]');
