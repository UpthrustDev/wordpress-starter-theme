...
?>
<div class="p-pay">
	<div class="p-pay__hero"></div>
	<div class="container container_narrow">

		<h1 class="p-pay__title"><?php the_title(); ?></h1>

		<div class="p-pay__messages">
			<?php form_pay_hook(); ?>
		</div>
		...
		<form id="order_review" method="post">
			...
			<table class="shop_table woocommerce-table--order-details">
				<thead>
					<tr>
			...
			<div id="payment">
				...
				<div class="form-row">
					...
					<div class="p-pay__details">
						<?php wc_get_template( 'checkout/terms.php' ); ?>
					</div>

					<?php do_action( 'woocommerce_pay_order_before_submit' ); ?>

					<div class="p-pay__action">
