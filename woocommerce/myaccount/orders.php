...
<?php if ( $has_orders ) : ?>
	...
	<h5 class="woocommerce-orders-table-header u-mb-20"><?php _e('Your recent orders', 'woocommerce'); ?></h5>
...
<?php else : ?>
	<div class="b-empty">
		<div class="b-empty__message"><?php _e( 'No order has been made yet.', 'woocommerce' ); ?></div>
	</div>
<?php endif; ?>
